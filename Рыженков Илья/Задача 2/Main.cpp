...
map<char*, int, wordComparator, BuddyAlloc<pair<char*, int>> >* find_words_custom_alloc(char* text)
{
	int word_start_position = 0;
	int i = 0;
	map<char*, int, wordComparator, BuddyAlloc<pair<char*, int>>>* dict = new map<char*, int, wordComparator, BuddyAlloc<pair<char*, int>>>();
	while (text[i] != 0)
	{
...
void elapse_time_custom_alloc(char* Text)
{
	...
	map<char*, int, wordComparator, BuddyAlloc<pair<char*, int>> >* res = find_words_custom_alloc(Text);
