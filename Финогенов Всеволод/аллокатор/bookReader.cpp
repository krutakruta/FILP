// bookReader.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
map<string, int, less<string>, CustomAllocator<pair<string, int>>> split_text_for_custom_allocator(char *text) {
	int a = 10;
	char *next_toc = NULL;
	map<string, int, less<string>, CustomAllocator<pair<string, int>>> words;
...
int main()
{
	...
	map<string, int, less<string>, CustomAllocator<pair<string, int>>> words_custom = split_text_for_custom_allocator(text);
