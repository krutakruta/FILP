...
struct MyAllocator {
    ...
    pointer allocate(size_t size) {
        ...
        lastP += size;
        cerr << "Allocated by address" << res << endl;
        return res;
    }
...
map<char*, size_t, MyComparator, BuddyAllocator<char *>> parseUsingMyAllocator(char* text) {
    auto wordsCounter = map<char*, size_t, MyComparator, BuddyAllocator<char*>>();
